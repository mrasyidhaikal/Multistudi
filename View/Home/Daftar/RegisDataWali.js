...
import ModelNewSiswa from "./../../../Model/RegistrasiNewSiswaModel";
...
class RegisDataWali extends React.Component {
  ...
  CobaModel = () => {
    console.log("cuba");
    console.log(ModelNewSiswa.state.mguardname);
  };
          ...
          <ScrollView>
            ...
            <View style={Style.ContainerViewBiasa}>
              ...
              <View style={Style.inputContainer}>
                <TextInput
                  style={Style.input}
                  placeholder={"Nama Wali cobaaa"}
                  placeholderTextColor={"#B2B5BF"}
                  underlineColorAndroid="transparent"
                  onChangeText={(val) =>
                    ModelNewSiswa.setState({ mguardname: val })
                  }
                />
              </View>
              <View style={Style.inputContainer}>
            ...
            <View style={Style.ContainerViewHorizontalSpace}>
              ...
              <TouchableOpacity
                style={Style.buttonBlank}
                onPress={() => this.CobaModel()}
              >
                <View style={{ flexDirection: "row" }}>
                  <Text style={Style.textNormalBlack}>Selanjutnyaaa</Text>
                  <Icon
