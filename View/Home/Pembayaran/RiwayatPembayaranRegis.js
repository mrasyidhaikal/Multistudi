      ...
      <View style={Style.container}>
        <SafeAreaView>
          <ScrollView>
            ...
            {/* Content */}
            {this.state.contentData.virtualaccount_full == null ?(
             <ListEmptyComponent/>
            )  : (
              <View
                style={[
              ...
              >
                ...
                >
                  <View style={{ flexDirection: "row" }}>
                    ...
                    >
                      {moment(this.state.contentData.duedate).format(
                        "Do MMMM YYYY, HH:mm"
                      )}{" "}
                      WIB
                    </Text>
                  ...
                  <View style={{ flexDirection: "row" }}>
                    ...
                    <Icon
                      ...
                      style={{ color: "#F15A23", marginLeft: 7 }}
                      size={20}
                    />
                  </View>
                </View>
                ...
                <TouchableOpacity
                  style={PembayaranStyle.containerMetodePembayaran}
