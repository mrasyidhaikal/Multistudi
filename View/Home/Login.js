  ...
  handleLogin = async () => {
    ...
    try {
      const response = await CallAPIData.getAPI(
        "http://104.248.156.113:8025/api/v1/AppAccount/login",
        JSON.stringify({
      ...
      <View style={[Style.container, { backgroundColor: merah }]}>
        <SafeAreaView>
          <ScrollView>
            ...
            >
              <Image
                source={require("../../assets/dotLogin.png")}
                style={{
                  opacity: 0.3,
                  width: 80,
                  height: 100,
            ...
            <View
              style={{ height: windowHeight - 145, backgroundColor: "white" }}
            >
              <View
                style={[
                  Style.inputContainer,
                  { marginTop: 30, marginHorizontal: 30 },
                ]}
              >
                <TextInput
              ...
              >
                <Text
                  style={{ alignSelf: "center", margin: 15, color: "#fff" }}
                >
                  Masuk
                </Text>
              </TouchableOpacity>
