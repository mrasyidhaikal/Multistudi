...
class Profile extends React.Component {
  ...
  handleWhatsapp = () => {
    Linking.openURL(this.state.whatsappUrl).catch((err) =>
          ...
          <ScrollView>
            <View style={Style.NavBackContainer}>
              ...
              >
                ...
                <Text style={{ color: "#B2B5BF", marginTop: 5 }}>
                  ...
                  >
                    <View style={{ flexDirection: "row" }}>
                      ...
                      <Text style={{ paddingRight: 15 }}>
                        {this.state.dataprofile["Handphone"]}
                      </Text>
                    </View>
                    <View style={{ flexDirection: "row" }}>
                      <Icon
              ...
              <View style={{ marginTop: 30 }}>
                ...
                <TouchableOpacity
                  style={{ marginTop: 20 }}
                  onPress={() =>
                    navigation.navigate("Profil", { screen: "InfoAplikasi" })
                  }
                >
                  <View
                    style={{
                ...
                <TouchableOpacity
                  style={{ marginTop: 20 }}
                  onPress={() =>
                    navigation.navigate("Profil", { screen: "TentangKami" })
                  }
                >
                  <View
                    style={{
                ...
                >
                  <View style={{ flexDirection: "row" }}>
                    <Icon
                      ...
                      size={28}
                    />
                    <Text style={{ margin: 5, fontSize: 14, color: "#EB3C3C" }}>
                      Logout
                    </Text>
                  </View>
                </TouchableOpacity>
